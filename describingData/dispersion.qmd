...
print(markdownTable(life_expectancy_variance_table.to_dict(orient='records')).getMarkdown())
```
:::
...
**Population SD** $$
\sigma = \sqrt\frac{\sum((x_i- \bar{x}{})\color{Red}{^2})} {N}
$$

**Sample Variance** $$
S^2 = \frac{\sum((x_i- \bar{x}{} )\color{red}{^2})} {N - 1}
$$ **Sample SD** $$
S = \sqrt\frac{\sum((x_i- \bar{x}{} )\color{red}{^2})} {N - 1}
$$
