...
Download and open the [normal_z_scores_percentages.xlsx](normal.xlsx) file in this repository to see data being used to create the below figure. To get the colors you need to use the "Select Data..." option when right clicking on the chart:

![Normal Distribution Z - scores with percentages](normal_z_percentages.png){fig-align="left" width="700" height="500"}
