...
These are the columns you would need to create a similar figure to the R and Python figures above:
...
plt.text(-1.85, 0.001, '34.1%', fontsize = 10,color='black',weight='bold')
plt.text(-2.7, 0.001, '13.6%', fontsize = 10,color='black',weight='bold')
...
![Z-score Distribution](normal-Figure4.png){fig-align="left" width="700" height="500"}
:::
