...
gdp_minus_10 = gapminder_2007['gdpPercap']
...
# correlation with original data + 5 to one variable (an additive change)
correlation_gdp_plus_5, pvalue__plus_5 = pearsonr(gdp_plus_5, gapminder_2007['lifeExp'])
...
# correlation with multiplication of 5 to one variable (multiplicative)
correlation_gdp_times_5, pvalue_times_5 = pearsonr(gdp_times_5, gapminder_2007['lifeExp'])
...
plt.subplot(2, 2, 2)
plt.scatter(gdp_plus_5, gapminder_2007['lifeExp'])
plt.title("Added 5 to GDP")

plt.subplot(2, 2, 3)
plt.scatter(gdp_minus_10, life_minus_10)
plt.title("Took 10 Away from GDP")

plt.subplot(2, 2, 4)
plt.scatter(gdp_times_5, gapminder_2007['lifeExp'])
plt.title("Multiplied GDP by 5")
...
![Correlation with original data + 5 to one variable (an additive change)](transforming_Table9.png){fig-align="left" width="600"}

![Correlation with original data - 10 to one variable (an additive change)](transforming_Table10.png){fig-align="left" width="600"}

![Correlation with multiplication of 5 to one variable (multiplicative) ](transforming_Table11.png){fig-align="left" width="600"}
