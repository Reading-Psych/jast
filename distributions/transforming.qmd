...
![Correlation with multiplication of 5 to both variables (multiplicative)](transforming_Table11.png){fig-align="left" width="600"} 
![Grid comparing the 4 transformations](transforming_Figure10.png){fig-align="left" width="650"}
:::
...
![Correlation between 'gdpPercap' and 'lifeExp'](transforming_Table8.png){fig-align="left" width="600"}
![Correlation between 'gdpPercap' and 'lifeExp' after log transformation](transforming_Table12.png){fig-align="left" width="600"}
![Correlation between 'gdpPercap' and 'lifeExp' after square root transformation](transforming_Table13.png){fig-align="left" width="600"}
![Correlation between 'gdpPercap' and 'lifeExp' after squared transformation](transforming_Table14.png){fig-align="left" width="600"}
![Grid comparing the 4 transformations](transforming_Figure11.png){fig-align="left" width="650"}
:::
...
```
![Table with skweness and kurtosis for 'gdpPercap' for Europe](transforming_Table15.png){fig-align="left" width="600"}
![Table with skweness and kurtosis for 'gdpPercap' for Africa](transforming_Table16.png){fig-align="left" width="600"}
:::
...
```
![Table with skweness and kurtosis for 'gdpPercap' for Europe after log transformation](transforming_Table17.png){fig-align="left" width="600"}
![Table with skweness and kurtosis for 'gdpPercap' for Africa after log transformation](transforming_Table18.png){fig-align="left" width="600"}
:::
