...
page_colors = list(
  ...
  ancova_bg = "white",                  ancova_text = "black",
  between_anova_bg = "orange",           between_anova_text = "black",
  binomial_bg = "white",                binomial_text = "black",
  central_tendency_bg = "white",        central_tendency_text = "black",
  contingency_bg = "white",             contingency_text = "black",
  correlations_bg = "white",            correlations_text = "black",
  dispersion_bg = "white",              dispersion_text = "black",
  dummy_effect_bg = "white",            dummy_effect_text = "black",
  fdr_bg = "white",                     fdr_text = "black",
  fwer_bg = "white",                    fwer_text = "black",
  fwer_vs_fdr_bg = "white",             fwer_vs_fdr_text = "black",
  glm_bg = "white",                     glm_text = "black",
  kurtosis_bg = "red",                kurtosis_text = "black",
  mediation_bg = "red",               mediation_text = "black",
  mixed_anova_bg = "orange",             mixed_anova_text = "black",
  multiple_regression_bg = "white",     multiple_regression_text = "black",
  normal_bg = "white",                  normal_text = "black",
  partial_correlations_bg = "white",    partial_correlations_text = "black",
  permutation_bg = "white",             permutation_text = "black",
  probability_bg = "white",             probability_text = "black",
  rep_measures_anova_bg = "red",      rep_measures_anova_text = "black",
  simple_regression_bg = "white",       simple_regression_text = "black",
  skewness_bg = "white",                skewness_text = "black",
  stats_basics_bg = "white",            stats_basics_text = "black",
  transforming_bg = "white",            transforming_text = "black",
